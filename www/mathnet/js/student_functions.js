...
function group_join_response(username, class_id, group_id, group_size) {
    ...
    //If Waves Script already appended then re-initialize the Waves app
    //else Append Waves App Script
    if(document.getElementById('waves_script'))
    {
        init_waves();
    }
    else
    {
        ...
        element.setAttribute('src','js/lib/require.min.js');
        element.setAttribute('data-main','js/main');
        element.setAttribute('id','waves_script');
