...
define([
    ...
    function (StateMachine, EventManager, Clock, Wave, UnitCircle, PhaseArrow, FrequencySlider, WavelengthSlider, StopWatch, HorizontalRuler, PlayButton, DirectionButton, WaveOverlay, SelectionBox, MembersList, Oscillator, Legend) {
        ...
        var PhaseWatcher = function (wave, color, startIndex) {
            ...
            function update () {
                ...
                if (point !== null) {
                    ...
                    phaseArrow.setColor(colors[point % members.length]);
                    if (point % members.length == members.indexOf(document.getElementById("username").value)) {
                    ...
                    oscillator.setColor(colors[point % members.length]);
                }
            }
